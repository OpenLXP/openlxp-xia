...
from openlxp_django_xia.core.management.utils.notification import send_notifications
from openlxp_django_xia.core.models import ReceiverEmailConfiguration, SenderEmailConfiguration
